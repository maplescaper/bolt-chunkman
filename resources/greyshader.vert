// Full-screen world-position grey-out (replaces the vertical-curtain approach).
...
// boundary hugs the terrain exactly and is completely camera-independent -- it
// can't float or smear like a projected curtain.
...
void main() {
  ...
  // bolt convention: flip y (matches lineshader.vert / fillshader.vert)
